...
def test():
    ...
    serial = serials[0]
    config = json.load(open('/home/ahrilab/Desktop/diffusion_policy_vila-main/diffusion_policy/real_world/realsense_config/435_high_accuracy_mode.json', 'r'))
    ...
    with SharedMemoryManager() as shm_manager:
        with SingleRealsense(
            ...
            video_path = '/home/ahrilab/codebase/diffusion_policy/data_local/test.mp4'
